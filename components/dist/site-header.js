...
function SiteHeader() {
    ...
    return (React.createElement("header", { className: "sticky top-0 z-50 w-full border-b bg-white" },
        React.createElement("div", { className: "container flex h-16 items-center justify-between" },
            ...
            React.createElement("button", { className: "md:hidden", onClick: function () { return setIsMenuOpen(!isMenuOpen); }, "aria-label": isMenuOpen ? "Close Menu" : "Open Menu", "aria-expanded": isMenuOpen.toString(), "aria-controls": "mobile-menu" }, isMenuOpen ? React.createElement(lucide_react_1.X, { className: "h-6 w-6" }) : React.createElement(lucide_react_1.Menu, { className: "h-6 w-6" }))),
