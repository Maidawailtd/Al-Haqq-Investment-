...
var Carousel = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(CarouselContext.Provider, { value: {
        ...
        React.createElement("div", __assign({ ref: ref, onKeyDownCapture: handleKeyDown, className: utils_1.cn("carousel-container", className), role: "region", "aria-roledescription": "carousel" }, props), children)));
});
