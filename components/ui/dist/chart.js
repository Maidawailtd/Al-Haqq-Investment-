...
require("./ChartStyles.css"); // Import external CSS file
...
var ChartContainer = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(ChartContext.Provider, { value: { config: config } },
        React.createElement("div", __assign({ "data-chart": chartId, ref: ref, className: utils_1.cn("chart-container", className) }, props),
