...
var PaginationPrevious = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(PaginationLink, __assign({ "aria-label": "Navigate to previous page", size: "default", className: utils_1.cn("gap-1 pl-2.5", className) }, props),
...
var PaginationNext = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(PaginationLink, __assign({ "aria-label": "Navigate to next page", size: "default", className: utils_1.cn("gap-1 pr-2.5", className) }, props),
