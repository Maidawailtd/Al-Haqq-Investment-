        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    newUser = { id: generateUniqueId(), email: email, name: name, passwordHash: passwordHash, role: "user" };
                    return [4 /*yield*/, usersCollection.insertOne(newUser)];
                case 3:
                    _a.sent();
                    return [2 /*return*/, { id: newUser.id, email: newUser.email, name: newUser.name, role: newUser.role }];
            }
        });
    });
}
